...
$(function(){
 ...
 <div class="btn-toolbar list-toolbar">
    <button class="btn btn-primary"><a href="<?php echo U('tadd');?>"><i class="fa fa-plus"></i>添加车队</a></button>
</div>
...
<table class="table">
  ...
  <tbody>
  <?php if(is_array($teams)): $i = 0; $__LIST__ = array_slice($teams,0,10,true);if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
      <td><?php echo ($vo["id"]); ?></td>
      <td><?php echo ($vo["name"]); ?></td>
      <td><?php echo ($vo["lines"]); ?></td>
      <td>
          <a href="<?php echo U('tedit',array('id'=>$vo['id']));?>"><i class="fa fa-pencil"></i></a>
         <a href="<?php echo U('tdelete',array('id'=>$vo['id']));?>" onclick="return del()" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
      </td>
