...
$(function(){
 ...
 <div class="btn-toolbar list-toolbar">
    <button class="btn btn-primary"><a href="<?php echo U('ladd');?>"><i class="fa fa-plus"></i>添加线路</a></button>
</div>
...
<table class="table">
  ...
  <tbody>
  <?php if(is_array($lines)): $i = 0; $__LIST__ = array_slice($lines,0,10,true);if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
      <td><?php echo ($vo["id"]); ?></td>
      <td><?php echo ($vo["name"]); ?></td>
      <td><?php echo ($vo["startcity"]); ?></td>
      <td><?php echo ($vo["endcity"]); ?></td>
      <td><?php echo ($vo["uptime"]); ?></td>
      <td>
          <a href="<?php echo U('ledit',array('id'=>$vo['id']));?>"><i class="fa fa-pencil"></i></a>
         <!--  <a onclick="myFunction()" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a> -->
         <a href="<?php echo U('ldelete',array('id'=>$vo['id']));?>" onclick="return del()" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
      </td>
...
<div class="view_center">
	<div class="pagination pagination-lg" ><?php echo ($page); ?></div>
</div>
