...
<div class="tab-pane active in" id="home">
      <form id="tab" action="/yidao/index.php/Admin/Index/aadd?pid=7" method="post">
        ...
        <div class="form-group">
            ...
            <select name="statue" id="DropDownTimezone" class="form-control">
            	<?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" 
              			<?php if(($admin['statue'] == $vo.id)): ?>selected="selected"<?php endif; ?> 
